...
//Model to separate all string data and the methods to fetch those data. This class will not know the existence of View Class.
class Model2: Contract.Model {
    ...
    override fun getNextCourse(onFinishedLister: Contract.Model.OnFinishedListener?) {
        Handler().postDelayed({onFinishedLister!!.onFinished(getRandomString)}, 1200)
    }
